<div id="deleteModal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4">
    ...
    <form id="deleteForm" action="" method="POST">
            ...
            <div class="p-6 text-center">
                ...
                <h3 class="text-lg font-bold text-slate-900 tracking-tight mb-2">Hapus Transaksi Ini?</h3>
                <p class="text-sm text-slate-500 leading-relaxed mb-8">
                    Tindakan ini tidak dapat dibatalkan. Saldo dompet terkait akan ikut disesuaikan kembali secara otomatis.
                </p>
