    ...
    <main class="px-4 pb-12 pt-8 sm:px-6 lg:px-8 bg-[#f8fafc] min-h-screen">
        <div class="mx-auto max-w-2xl">
            ...
            <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                <form action="{{route('dompet.store')}}" method="POST" class="p-6 sm:p-8">
                    @csrf
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select id="aktif"
                                    ...
                                    <option value="1">Aktif (Dapat digunakan untuk transaksi)</option>
                                    <option value="0">Tidak Aktif (Disembunyikan sementara)</option>
                                </select>
